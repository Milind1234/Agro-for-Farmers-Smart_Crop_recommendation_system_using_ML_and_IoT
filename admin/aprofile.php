...
<?php require ('anav.php'); ?>
  ...
  <section class="section section-shaped section-lg" style="background-image: url('../assets/img/backgroundimg1.webp'); background-size: cover; background-position: center;">
    <div class="shape shape-style-1" style="background: rgba(0, 0, 0, 0.5);">
      <span></span>
      <span></span>
      <span></span>
      <span></span>
          ...
          <div class="row row-content">
            <div class="col-md-4 mb-3">
              ...
              <div class="card mb-3">
				...
				<li class="list-group-item">Admin can modify and view all the farmers's details when necessary.</li>
				<li class="list-group-item">Admin can manage the farmer's details</li>
