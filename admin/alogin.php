...
<body>
  ...
  <!-- Form Section -->
  <section class="section-lg mt-5 section-spacing">
    <div class="container">
          ...
          <div class="form-section">
            ...
            <form method="post" action="">
              <div class="form-group">
                ...
                <input type="text" id="admin_name" class="form-control" name="admin_name" placeholder="Enter Admin ID">
              </div>
              <div class="form-group">
                <label for="password">Password</label>
                <div class="input-group">
                  <input type="password" id="password" name="admin_password" class="form-control" placeholder="Password">
              ...
              <div class="text-center">
                <button type="submit" class="btn-login" name="adminlogin" id="submit" value="submit">Login</button>
              </div>
